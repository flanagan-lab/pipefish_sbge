...
S = 2.2204e+12, p-value < 2.2e-16
alternative hypothesis: true rho is not equal to 0
sample estimates:
      rho 
0.2415024 

Still a weak positive correlation in the gonad and gills, but now the liver shows a week negative correlation. 
...
dds_SN_exp$organ <- ifelse(dds_SN_exp$organ %in% c("Ovaries", "Testes"),
                           paste0("Gonad"), 
