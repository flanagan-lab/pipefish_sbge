...
#Create a list of the files I want
SN_blast_files <- list.files(blast_path, pattern = "top")
...
blast_output_merged$SN_femG_top27TRgenes_danio_blast <- merge(as.data.frame(gill_fem_biased), blast_output_merged$SN_femG_top27TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_femGon_top50TRgenes_danio_blast <- merge(as.data.frame(gonad_fem_biased), blast_output_merged$SN_femGon_top50TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE) 

blast_output_merged$SN_femL_top50TRgenes_danio_blast <- merge(as.data.frame(liver_fem_biased), blast_output_merged$SN_femL_top50TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_maleG_top27TRgenes_danio_blast <- merge(as.data.frame(gill_mal_biased), blast_output_merged$SN_maleG_top27TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_maleGon_top50TRgenes_danio_blast <- merge(as.data.frame(gonad_mal_biased), blast_output_merged$SN_maleGon_top50TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_maleL_top50TRgenes_danio_blast <- merge(as.data.frame(liver_mal_biased), blast_output_merged$SN_maleL_top50TRgenes_danio_blast, by = "trin_geneid", all.y = TRUE)

```

```{r, eval=FALSE}
#Write once then comment out
#write.table(c(blast_output_merged$SN_femG_top27TRgenes_danio_blast$gene_name, blast_output_merged$SN_femGon_top50TRgenes_danio_blast$gene_name, blast_output_merged$SN_femL_top50TRgenes_danio_blast$gene_name, blast_output_merged$SN_maleG_top27TRgenes_danio_blast$gene_name, blast_output_merged$SN_maleGon_top50TRgenes_danio_blast$gene_name, blast_output_merged$SN_maleL_top50TRgenes_danio_blast$gene_name),
 #          'SN_GOnames.txt', 
  #          sep = " ", 
   #         quote=FALSE, 
    #        row.names = FALSE, 
...
#write once then comment out
#write.table(rbind(blast_output_merged$SN_femG_top27TRgenes_danio_blast[,c("gene_name", "log2FoldChange")],
 #             blast_output_merged$SN_femGon_top50TRgenes_danio_blast[,c("gene_name", "log2FoldChange")],
  #            blast_output_merged$SN_femL_top50TRgenes_danio_blast[,c("gene_name", "log2FoldChange")],
   #           blast_output_merged$SN_maleG_top27TRgenes_danio_blast[,c("gene_name", "log2FoldChange")],
    #          blast_output_merged$SN_maleGon_top50TRgenes_danio_blast[,c("gene_name", "log2FoldChange")],
     #         blast_output_merged$SN_maleL_top50TRgenes_danio_blast[,c("gene_name", "log2FoldChange")]),
      #      'SN_GOnames_FC.txt',
       #     sep = "\t",
        #    quote = FALSE,
         #   row.names = FALSE,
...
blast_output_merged$SN_femG_top27TRgenes_danio_blast <-
  merge(blast_output_merged$SN_femG_top27TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
blast_output_merged$SN_femGon_top50TRgenes_danio_blast <-
  merge(blast_output_merged$SN_femGon_top50TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
blast_output_merged$SN_femL_top50TRgenes_danio_blast <-
  merge(blast_output_merged$SN_femL_top50TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
blast_output_merged$SN_maleG_top27TRgenes_danio_blast <-
  merge(blast_output_merged$SN_maleG_top27TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
blast_output_merged$SN_maleGon_top50TRgenes_danio_blast <-
  merge(blast_output_merged$SN_maleGon_top50TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
blast_output_merged$SN_maleL_top50TRgenes_danio_blast <-
  merge(blast_output_merged$SN_maleL_top50TRgenes_danio_blast, 
        panther[, c(2,5)], 
        by.x = "gene_name", 
        by.y = "MappedID", 
        all.x = TRUE)
...
colnames(all_go_dat) <- c(
  colnames(go_tabs$SN_femG_top27TRgenes_danio_blast),
  "bias_cat", "tissue"
)
...
### Do it for all DEGs, not just top 50 and top 27
...
```{r load in data}
Male_gon_biased <- read.delim("data/SN_malGon_biased_TRgenes.txt") 

Male_L_biased <- read.delim("data/SN_malL_biased_TRgenes.txt")

Male_G_biased <- read.delim("data/SN_malG_biased_TRgenes.txt")

female_gon_biased <- read.delim("data/SN_femGon_biased_TRgenes.txt") 

Female_L_biased <- read.delim("data/SN_femL_biased_TRgenes.txt")

Female_G_biased <- read.delim("data/SN_femG_biased_TRgenes.txt")
...
#Create dataframes for all of the above that contains the trinity gene ID and the logFoldChange
MGonad_df <- as.data.frame(cbind(trin_geneid = Male_gon_biased$trin_geneid,
                                       LogFC = Male_gon_biased$log2FoldChange))
MGill_df <- as.data.frame(cbind(trin_geneid = Male_G_biased$trin_geneid,
                                       LogFC = Male_G_biased$log2FoldChange))
MLiver_df <- as.data.frame(cbind(trin_geneid = Male_L_biased$trin_geneid,
                                       LogFC = Male_L_biased$log2FoldChange))

FGonad_df <- as.data.frame(cbind(trin_geneid = female_gon_biased$trin_geneid, 
                                      LogFC = female_gon_biased$log2FoldChange))
FGill_df <- as.data.frame(cbind(trin_geneid = Female_G_biased$trin_geneid, 
                                      LogFC = Female_G_biased$log2FoldChange))
FLiver_df <- as.data.frame(cbind(trin_geneid = Female_L_biased$trin_geneid, 
                                      LogFC = Female_L_biased$log2FoldChange))
