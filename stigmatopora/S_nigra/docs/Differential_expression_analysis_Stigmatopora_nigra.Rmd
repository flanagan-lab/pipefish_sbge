...
#Create a list of the files I want
SN_blast_files <- list.files(blast_path, pattern = "danio")
...
```{r merge-blast-logfc}
blast_output_merged$SN_femG_biased_TRgenes_blast <- merge(as.data.frame(gill_fem_biased), blast_output_merged$SN_femG_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_femGon_biased_TRgenes_blast <- merge(as.data.frame(gonad_fem_biased), blast_output_merged$SN_femGon_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_femL_biased_TRgenes_blast <- merge(as.data.frame(liver_fem_biased), blast_output_merged$SN_femL_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_malG_biased_TRgenes_blast <- merge(as.data.frame(gill_mal_biased), blast_output_merged$SN_malG_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_malGon_biased_TRgenes_blast <- merge(as.data.frame(gonad_mal_biased), blast_output_merged$SN_malGon_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)

blast_output_merged$SN_malL_biased_TRgenes_blast <- merge(as.data.frame(liver_mal_biased), blast_output_merged$SN_malL_biased_TRgenes_blast, by = "trin_geneid", all.y = TRUE)
```