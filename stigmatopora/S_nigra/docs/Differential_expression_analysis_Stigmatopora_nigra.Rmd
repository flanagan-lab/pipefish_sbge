...
#write.table(c(blast_output_merged$SN_femG_allTRgenes_danio_blast$gene_name, blast_output_merged$SN_femGon_allTRgenes_danio_blast$gene_name, blast_output_merged$SN_femL_allTRgenes_danio_blast$gene_name, blast_output_merged$SN_maleG_allTRgenes_danio_blast$gene_name, blast_output_merged$SN_maleGon_allTRgenes_danio_blast$gene_name, blast_output_merged$SN_maleL_allTRgenes_danio_blast$gene_name),
 #          'SN_GOnames.txt', 
  #          sep = " ", 
   #         quote=FALSE, 
    #        row.names = FALSE, 
