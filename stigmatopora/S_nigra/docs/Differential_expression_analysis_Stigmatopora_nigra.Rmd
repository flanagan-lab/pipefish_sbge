...
blast_output_filtered$SN_maleG_top50TRgenes_blast <- merge(top50_MGill_df, blast_output_filtered$SN_maleG_top50TRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
