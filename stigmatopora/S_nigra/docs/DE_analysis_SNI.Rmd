...
logFC_long$bias                       2 100708   50354 25056.36 < 2.2e-16 ***
logFC_long$tissue                     2   7980    3990  1985.45 < 2.2e-16 ***
logFC_long$bias:logFC_long$tissue     4   4527    1132   563.17 < 2.2e-16 ***
Residuals                         93273 187444       2                       
---
...
blast_output_filtered$SN_femGon_allTRgenes_blast <- merge(all_FGonad_df, blast_output_filtered$SN_femL_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
