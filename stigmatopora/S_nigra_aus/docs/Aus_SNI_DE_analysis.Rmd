...
```{r anz-aus-upset}
#Import NZ S. nigra data
nz_gill_mal_biased <- read.table("data/nz_nigra_exp/nz_gill_mal_biased.txt")
nz_gill_fem_biased <- read.table("data/nz_nigra_exp/nz_gill_fem_biased.txt")
nz_liver_mal_biased <- read.table("data/nz_nigra_exp/nz_liver_mal_biased.txt")
nz_liver_fem_biased <- read.table("data/nz_nigra_exp/nz_liver_fem_biased.txt")

#Checking there is no overlap between the two sexes
listInputall <- list("Aus Male Gill"=rownames(gill_mal_biased), 
                  "Aus Male Liver"=rownames(liver_mal_biased),
                  "Aus Female Gill"=rownames(gill_fem_biased), 
                  "Aus Female Liver"=rownames(liver_fem_biased),
                  "NZ Male Gill"=rownames(nz_gill_mal_biased),
                  "NZ Female Gill"=rownames(nz_gill_fem_biased),
                  "NZ Male Liver"=rownames(nz_liver_mal_biased),
                  "NZ Female Liver"=rownames(nz_liver_fem_biased))

# Define the desired order of sets
desired_order <- c("Aus Male Gill", "Aus Female Gill", "Aus Male Liver", "Aus Female Liver", "NZ Male Gill", "NZ Female Gill", "NZ Male Liver", "NZ Female Liver")
