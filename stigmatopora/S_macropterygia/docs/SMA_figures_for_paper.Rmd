...
# put the patchworks together
figPCA_supp_hm <-  wrap_plots(hms, ncol=2) + 
  plot_annotation(tag_levels = 'A') 

ggsave("figs/FigPCA_heatmaps_supp.pdf", figPCA_supp, height=4, width=8)
ggsave("figs/FigPCA_heatmaps)supp.png", figPCA_supp, height=4, width=8)
```
