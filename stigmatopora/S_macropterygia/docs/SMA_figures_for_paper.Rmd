...
for(organ in c("Gill","Liver","Gonad")){
  ...
  logFC_long_all$abs_logFC<-abs(logFC_long_all$logFC)
  plot(logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="MB",]$tau~logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="MB",]$abs_logFC,
       bty='l',
  ...
  points(logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="FB",]$tau~logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="FB",]$abs_logFC,
       bty='l',
       col=scales::alpha(sex_cols["F"],0.5),
       pch=16,
       cex=1.5)
  #abline(lm(logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="MB",]$tau~logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="MB",]$abs_logFC),
         #lwd=2.5,
         #col=sex_cols["M"])
  #abline(lm(logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="FB",]$tau~logFC_long_all[logFC_long_all$tissue==organ & logFC_long_all$bias=="FB",]$abs_logFC),
         #lwd=2.5,
         #col=sex_cols["F"])
  dev.off()
}
...
for(organ in c("Gill","Liver","Gonad")){
  ...
  mtext(side=3,organ,font=2,cex=1.5)
  mtext(side=1,expression(tau["TPM"]),line=2,cex=1.5)
  dev.off()
}
