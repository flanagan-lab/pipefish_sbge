...
Here I am getting the trinity gene IDs that correspond to the top 50 differentially expressed genes for males and females. Because there are only 16 female-biased and male-biased genes I will only use those.
...
#Pulling the top 16 diff expressed genes in Males
#top16_MGill_trin_genes <- cbind(rownames(head(gill_con_res_p05[order(
 # gill_con_res_p05$log2FoldChange, decreasing = TRUE),], n=16)))

#Run once to create the file and then commented out
#write.table(top50_MGill_trin_genes,
 #           'SM_maleG_top16TRgenes.txt', 
  #          sep = "", 
   #         quote=FALSE, 
    #        row.names = FALSE, 
     #       col.names = FALSE)
...
#DO THIS FOR ALL THE THINGS WHEN YOU CAN BE BOTHERED
FGill_trin_genes <- cbind(rownames(gill_con_res_p05[order(
  gill_con_res_p05$log2FoldChange, decreasing = FALSE),]))

#Run once to create the file and then commented out
#write.table(top27_FGill_trin_genes,
 #           'SM_femG_top27TRgenes.txt', 
  #          sep = "", 
   #         quote=FALSE, 
    #        row.names = FALSE, 
     #       col.names = FALSE)
