...
```
This pipeline follows a pipeline outlined for _Syngnathus floridae_, written by Coley Tosto. Changes in scripts and outputs are outlined in this document. This pipeline was run on the University of Canterbury's RCC.
