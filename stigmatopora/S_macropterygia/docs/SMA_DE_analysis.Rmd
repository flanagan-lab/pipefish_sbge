...
blast_path <- "//file/Research/FlanaganLab/intermediate_data/SMA_DE_pipeline_analysis_2024/07_TRgenes/cory_BLAST"

#Create a list of the files I want
SM_blast_files <- list.files(blast_path, 
                             pattern = "cory",
                             full.names = TRUE)
...
blast_output_all <- read.csv("data/SM_blast_output.csv")

blast_SB_merged <- merge(logFC_long_tauSB, blast_output_all, by = "trin_geneid", all = TRUE)

#write once then comment out
#write.csv(as.data.frame(blast_SB_merged), "data/SM_blast_SB_merged.csv", row.names = TRUE)

#add SS dataset
logFC_long_tauSS <- read.csv("data/logFC_long_taubias_SS.csv")

blast_SB_SS_merged <- merge(blast_SB_merged, logFC_long_tauSS, by = "trin_geneid", all = TRUE)

#write once then comment out
#write.csv(as.data.frame(blast_SB_SS_merged), "data/SM_blast_SB_SS_merged.csv", row.names = TRUE)
```
