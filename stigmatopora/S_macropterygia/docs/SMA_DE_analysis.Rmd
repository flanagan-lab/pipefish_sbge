...
Given this, I think I will remove these "UB" genes -- if the model couldn't tell them apart, then probably I don't want to try to treat them as sex specific. Our sample sizes are quite low, so I'll err on the side of stringency.

```{r}
ss_remove<-ssinfo[ssinfo$bias.x=="UB",]
sex_specific_genes<-sex_specific_genes[!sex_specific_genes$merger %in% ss_remove$merger,]
ssinfo<-ssinfo[ssinfo$bias.x!="UB",]
```
