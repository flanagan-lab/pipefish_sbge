...
for(gene in random_ub_ss){
  ...
  plotCounts(ddsMF_SM[,ddsMF_SM$organ == organ], 
...
The maximum number of observations per gene is `r max(table(logFC_long$geneID))`, which is what we would expect -- one per organ. So that's great!
