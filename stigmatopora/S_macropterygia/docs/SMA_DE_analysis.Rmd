...
logFC_long$bias                       2  76554   38277 16542.5 < 2.2e-16 ***
logFC_long$tissue                     2  12586    6293  2719.7 < 2.2e-16 ***
logFC_long$bias:logFC_long$tissue     4  30849    7712  3333.0 < 2.2e-16 ***
Residuals                         82148 190080       2                      
---
...
blast_long_SS <- data.frame(
  tissue=c(rep("Gill", 
               sum(nrow(blast_output_filtered_SS$SM_femG_specific_TRgenes_corythoicthys_blast),
                   nrow(blast_output_filtered_SS$SM_malG_specific_TRgenes_corythoicthys_blast))),
           rep("Gonad", 
  ...
  sex=c(rep("Female",
            nrow(blast_output_filtered_SS$SM_femG_specific_TRgenes_corythoicthys_blast)),
        rep("Male",
            nrow(blast_output_filtered_SS$SM_malG_specific_TRgenes_corythoicthys_blast)),
        rep("Female",
  ...
  gene=c(blast_output_filtered_SS$SM_femG_specific_TRgenes_corythoicthys_blast$gene,
         blast_output_filtered_SS$SM_malG_specific_TRgenes_corythoicthys_blast$gene,
         blast_output_filtered_SS$SM_femGon_specific_TRgenes_corythoicthys_blast$gene,
  ...
  protein=c(blast_output_filtered_SS$SM_femG_specific_TRgenes_corythoicthys_blast$protein,
            blast_output_filtered_SS$SM_malG_specific_TRgenes_corythoicthys_blast$protein,
            blast_output_filtered_SS$SM_femGon_specific_TRgenes_corythoicthys_blast$protein,
  ...
  trinityID=c(blast_output_filtered_SS$SM_femG_specific_TRgenes_corythoicthys_blast$trin_geneid,
              blast_output_filtered_SS$SM_malG_specific_TRgenes_corythoicthys_blast$trin_geneid,
              blast_output_filtered_SS$SM_femGon_specific_TRgenes_corythoicthys_blast$trin_geneid,
...
write.csv(blast_long_SS, "SM_BLAST_results_sex_specific.csv", row.names = FALSE)
```
