...
### Further investigation of key hub genes
...
```{r}
mods<-c("black","blue","red","turquoise")
...
for(module in mods){
  this_mod<-all_hub_gene_info[all_hub_gene_info$module.x==module,]
  
  plot(this_mod$GeneSignificance, this_mod$logFC,
