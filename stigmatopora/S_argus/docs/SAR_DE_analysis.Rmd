...
write.table(rbind(blast_output_merged$SA_femG_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            blast_output_merged$SA_femGon_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            blast_output_merged$SA_femL_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            blast_output_merged$SA_maleG_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            blast_output_merged$SA_maleGon_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            blast_output_merged$SA_maleL_TRgenes_corythoicthys_blast[,c("gene_name", "log2FoldChange")],
            'data/SA_cory_names_FC.txt',
            sep = "\t",
            quote=FALSE,
            row.names = FALSE,
            col.names = FALSE)
