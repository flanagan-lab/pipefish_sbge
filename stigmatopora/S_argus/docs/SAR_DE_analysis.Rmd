...
blast_output_filtered$SA_femG_allTRgenes_blast <- merge(all_FGill_df, blast_output_filtered$SA_femG_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
blast_output_filtered$SA_femGon_allTRgenes_blast <- merge(all_FGonad_df, blast_output_filtered$SA_femL_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
blast_output_filtered$SA_femL_allTRgenes_blast <- merge(all_FLiver_df, blast_output_filtered$SA_femL_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
blast_output_filtered$SA_maleG_allTRgenes_blast <- merge(all_MGill_df, blast_output_filtered$SA_maleG_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
blast_output_filtered$SA_maleGon_allTRgenes_blast <- merge(all_MGonad_df, blast_output_filtered$SA_maleGon_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
blast_output_filtered$SA_maleL_allTRgenes_blast <- merge(all_MLiver_df, blast_output_filtered$SA_maleL_allTRgenes_corythoicthys_blast, by = "trin_geneid", all.x = TRUE, all.y = TRUE)
```