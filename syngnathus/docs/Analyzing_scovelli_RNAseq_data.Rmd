...
This script was run in a screen session as `bash bash_scripts/trin_super_transcripts.sh trinity_out_dir_scovelli_Oct2023.Trinity.fasta`. It took about 11 minutes to run.
