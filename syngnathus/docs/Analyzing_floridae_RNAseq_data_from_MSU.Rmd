...
After filtering we can now perform the standard differential expression analysis tht is wrapped into DESeq2.
```{r diff-exp}
...
#Re-set the design for the multi-factor set-up
design(ddsMF_FL) <- formula( ~ Sex + Organ)
ddsMF_FL <- DESeq(ddsMF_FL)
