...
head(liver_con_res)
liver_res_noNA <- liver_con_res[!is.na(liver_con_res$padj),]

liver05 <- liver_res_noNA[liver_res_noNA$padj < 0.05,]
top20_Fliver05 <-cbind(rownames(head(liver05[order(liver05$log2FoldChange, decreasing = FALSE),], n=20)))
write.table(top20_Fliver05,
            'FL_femL_top20TRgenes05.txt', 
            sep = "", 
            quote=FALSE, 
            row.names = FALSE, 
            col.names = FALSE)
