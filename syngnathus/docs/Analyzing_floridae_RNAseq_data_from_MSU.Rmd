...
```{bash run_transrate_readmap, file='bash/transrate.sh', eval = FALSE}
...
```{bash rnaQUAST.sh, file='bash/rnaQUAST.sh', eval=FALSE}
...
```{bash rnaQUAST_ref.sh, file='bash/rnaQUAST_ref.sh', eval=FALSE}
