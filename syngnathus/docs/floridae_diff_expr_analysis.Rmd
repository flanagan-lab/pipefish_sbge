...
A BLAST database was generated with the _D. reiro_ genome as:
`makeblastdb -in ../ncbi_dataset/data/GCF_000002035.6/GCF_000002035.6_GRCz11_genomic.fna -out d_rerio_genome -dbtyp nucl`


The trinity gene IDs that correspond to ALL of the female- or male-biased genes wer pulled out and saved to `.txt` files.
