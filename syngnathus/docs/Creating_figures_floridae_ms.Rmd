...
txi.salmon <- readRDS("plot_data/txi.salmon.floride.RDS")
...
norm_counts<-counts(dds_FL_exp, normalized = TRUE)
...
pdf("figs/Fig1A_PCA.pdf",height = 6,width=6)
...
```{r assembleFig1, message=FALSE}
fig1a <- image_ggplot(image_read_pdf('figs/Fig1A_PCA.pdf'),interpolate = TRUE)
fig1b <- image_ggplot(image_read_pdf('figs/Fig1B_PCA.pdf'),interpolate = TRUE)
fig1c <- image_ggplot(image_read_pdf('figs/Fig1C_top20_heatmap.pdf'),interpolate = TRUE)
fig1d <- image_ggplot(image_read_pdf('figs/Fig1D_top20_organs_heatmap.pdf'),interpolate = TRUE)
...
ggsave("figs/Fig1.pdf",fig1, height=5, width=5)
ggsave("figs/Fig1.png",fig1, height=5, width=5) # also save as a png
```
...
```{r fig2a}
pdf("figs/Fig2A_logFC_boxplots.pdf",width = 8, height=3.5)
...
```{r fig2b}
pdf("figs/Fig2B_biasCat_counts.pdf",width = 8, height=3.5)
...
pdf("figs/Fig2C_sexbias_upset.pdf",width = 8, height=5)
...
```{r fig2D}
pdf("figs/Fig2D_GO_barplot.pdf",height=14, width=12)
ggplot(all_go_sums, 
...
fig2a <- image_ggplot(image_read_pdf('figs/Fig2A_logFC_boxplots.pdf'),interpolate = TRUE)
fig2b <- image_ggplot(image_read_pdf('figs/Fig2B_biasCat_counts.pdf'),interpolate = TRUE)
fig2c <- image_ggplot(image_read_pdf('figs/Fig2C_sexbias_upset_color.pdf'),interpolate = TRUE)
fig2d <- image_ggplot(image_read_pdf('figs/Fig2D_GO_barplot.pdf'),interpolate = TRUE)
...
fig2
ggsave("figs/Fig2.pdf",fig2, height=6, width=8)
ggsave("figs/Fig2.png",fig2, height=6, width=8)
...
```{r}
pdf("figs/Fig3A_tau_sexbias_v2.pdf",width = 8, height=5)
par(oma=c(2,2,1,2),
    mar=c(2,2,1,2),
    xpd=FALSE)
...
pdf("figs/Fig3B_tau_biascat_violins.pdf",width = 12, height=3.75)
logFC_long_all_ss %>%
...
fig3a <- image_ggplot(image_read_pdf('figs/Fig3A_tau_sexbias_v2.pdf'),interpolate = TRUE)
fig3b <- image_ggplot(image_read_pdf('figs/Fig3B_tau_biascat_violins.pdf'),interpolate = TRUE)
...
ggsave("figs/Fig3.pdf",fig3,height = 4, width=16)
ggsave("figs/Fig3.png",fig3,height = 4, width=16)
...
ggsave("figs/Fig4.pdf",fig4,height = 4, width=8)
ggsave("figs/Fig4.png",fig4,height = 4, width=8)
