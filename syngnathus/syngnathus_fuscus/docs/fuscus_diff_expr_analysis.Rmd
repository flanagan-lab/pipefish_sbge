...
```{r sex-specific-counts, echo = FALSE}
...
knitr::kable(FU_sex_specific_counts)
...
```{r figSB-HM, message=FALSE, eval = FALSE}
...
```{r readin_blast_results_SSgenes, echo=FALSE, eval=FALSE}
#Create a list of the files I want
...
#pdf("docs/figs/FigGO_SBGbarplot.pdf",height=12, width=14)
...
ggsave("docs/figs/FigGO_all.pdf", figGO, height=10, width=8)
