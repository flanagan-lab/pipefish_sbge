...
#Set PCA organ shapes
pca_organ_shapes <- c(Gonad = 21, Gill = 22, Liver = 24)

#Create the plot for PC1 v PC2
plot(pca_plotting_data$PC1,
     pca_plotting_data$PC2,
     bg = paste0(sex_cols[pca_plotting_data$Sex], "75"),   
     col = sex_cols[pca_plotting_data$Sex],                
     pch = pca_organ_shapes[pca_plotting_data$Organ],
     cex = 2,
     lwd = 2,  
     cex.lab = 2,
     cex.axis = 1.75,
...
outer_legend("top",
             ...
             pch = 23,  # filled symbol
             pt.bg = paste0(sex_cols, "75"),
             col = sex_cols,                   
             pt.lwd = 2,
             pt.cex = 3,
             cex = 1.75,
